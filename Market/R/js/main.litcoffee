    require.config
        baseUrl: "js"
        paths:
            'angular': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.19/angular.min'
            'angular-route': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.19/angular-route.min'
